...
public static class MessageInfo
{
    ...
    public static Type GetTypeByContract(this string contractId)
    {
        ...
        {
            string uppercaseContractId = contractId.ToUpper(); // Keep in mind that contractId is case-sensitive. We are doing this check because the framework is using lowercase contractIds everywhere,
